    ...
    function displayEvents(events, page) {
        ...
        for (let i = startIndex; i < endIndex; i++) {
            ...
            row.innerHTML = `
                ...
                <td>
                    <a id="eventDetailButton" href="/event/${event.id}" class="text-white bg-blue-600 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Détails</a>
                </td>
            `;
